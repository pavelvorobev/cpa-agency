...
import { DEFAULT_CATEGORIES, FALLBACK_CONTENT, type MultiplyCategoryId } from './categories'
...
export function useMultiplySection() {
  ...
  const content = computed(() => contentById.value[activeId.value] ?? FALLBACK_CONTENT[activeId.value])
